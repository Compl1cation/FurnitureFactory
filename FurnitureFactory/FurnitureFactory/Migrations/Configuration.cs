namespace FurnitureFactory.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            //           //Seed 1000 Products with random Name and Bar Code for testing
            //           for (int i = 0; i < 1000; i++)
            //           {
            //               context.Furniture.AddOrUpdate(f => f.Name,
            //                   new Furniture { Name = string.Concat(i.ToString(), RandomString(5).ToString()), BarCode = (RandomString(9)), PricePerUnit = i, Weight = i });
            //           }
            ...
            //new Order { ClientId = "1ed52ca1-b777-4378-b77c-806a97885cf2", Date = DateTime.Parse("2016-08-18 10:34:04 AM"), RecieptNumber = "4123457547", TotalPrice = 437.22m },
            //new Order { ClientId = "69aa2d04-7d29-461e-8bb7-6005b8dfd37f", Date = DateTime.Parse("2016-08-18 10:34:13 AM"), RecieptNumber = "4235457555", TotalPrice = 628.33m },
            //new Order { ClientId = "c71cb63f-8482-4a33-b7e3-71efca58b6c6", Date = DateTime.Parse("2015-03-02 03:42:55 PM"), RecieptNumber = "4235466551", TotalPrice = 450.28m }
            //);

            //context.FurnitureOrder.AddOrUpdate(
            //   new FurnitureOrder { FurnitureId = 3, OrderId = 3, Quantity = 2 },
            //   new FurnitureOrder { FurnitureId = 4, OrderId = 3, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 1, OrderId = 4, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 2, OrderId = 4, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 3, OrderId = 4, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 4, OrderId = 4, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 5, OrderId = 4, Quantity = 1 },
            //   new FurnitureOrder { FurnitureId = 1, OrderId = 5, Quantity = 2 },
            //   new FurnitureOrder { FurnitureId = 5, OrderId = 5, Quantity = 2 }
            //   );
